...
LinePlotViewWidget::LinePlotViewWidget() : 
    QOpenGLWidget(),
...
void LinePlotViewWidget::setData(const std::vector<mv::Vector2f>& points, float pointSize, float pointOpacity)
{
...
void LinePlotViewWidget::initializeGL()
{
    initializeOpenGLFunctions();

    connect(context(), &QOpenGLContext::aboutToBeDestroyed, this, &LinePlotViewWidget::cleanup);
...
void LinePlotViewWidget::resizeGL(int w, int h)
{
...
void LinePlotViewWidget::paintGL()
{
    initializeOpenGLFunctions();
...
void LinePlotViewWidget::cleanup()
{
