...
SettingsAction::SettingsAction(QObject* parent, const QString& title) :
    ...
    _linePlotViewPlugin(dynamic_cast<LinePlotViewPlugin*>(parent)),
    ...
    _pointOpacityAction(this, "Opacity", 0.f, 1.f, 0.75f, 2)
{
    ...
    connect(&_pointSizeAction, &DecimalAction::valueChanged, _linePlotViewPlugin, &LinePlotViewPlugin::updatePlot);
    connect(&_pointOpacityAction, &DecimalAction::valueChanged, _linePlotViewPlugin, &LinePlotViewPlugin::updatePlot);
